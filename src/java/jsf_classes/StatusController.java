...
import session_beans.StatusFacade;
...
public class StatusController implements Serializable {
    ...
    @EJB
    private session_beans.StatusFacade ejbFacade;
    ...
    public Status getStatus(java.lang.String id) {
    ...
    public static class StatusControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Status) {
                ...
                return getStringKey(o.getStatus());
            } else {
