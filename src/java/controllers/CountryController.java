...
import session_beans.CountryFacade;
...
public class CountryController implements Serializable {
    ...
    @EJB private session_beans.CountryFacade ejbFacade;
    ...
    public Country getCountry(java.lang.String id) {
    ...
    public static class CountryControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Country) {
                ...
                return getStringKey(o.getCountry());
            } else {
